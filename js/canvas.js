const COLORS = ["255,108,80", "5,117,18", "29,39,57", "67,189,81", "255, 170, 0"];
...
class Bubble {
    ...
    init() {
        ...
        this.size = generateDecimalBetween(3, 17);
        ...
        this.movementX = generateDecimalBetween(-10, 10) / this.velocity;
        this.movementY = generateDecimalBetween(1, 15) / this.velocity;
    }
